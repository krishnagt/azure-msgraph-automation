...
###############################################################################
# Author: GTKrishna
# File: Intune-Offboarding-Tool.ps1
#
# Description:
# This PowerShell script provides a WPF-based GUI for searching and 
# offboarding Windows devices from Microsoft Intune, Autopilot, and Azure AD. 
# It integrates with Microsoft Graph API and allows administrators to perform 
# device lifecycle management tasks through an interactive interface.
#
# Key functions:
# - Installs and verifies Microsoft Graph PowerShell modules.
# - Authenticates to Microsoft Graph with Intune and Directory scopes.
# - Provides a GUI with options to:
#     * Search for a device by name.
#     * Display device details (serial number, OS, user, compliance).
#     * Show status of Intune, Autopilot, and Azure AD enrollment.
#     * Offboard a device by removing it from Intune, Autopilot, and Azure AD.
# - Implements error handling and user-friendly message boxes.
#
# Notes:
...
# - Must run with appropriate Microsoft Graph API permissions.
# - Useful for IT admins handling device decommissioning/offboarding.
#
# Date: 15-10-2023
###############################################################################
#>
